...
import { parseMarkdownToBlocks, exportDiff } from './utils/parser';
import { Viewer, ViewerHandle } from './components/Viewer';
import { AnnotationPanel } from './components/AnnotationPanel';
import { Landing } from './components/Landing';
import { ExportModal } from './components/ExportModal';
import { Annotation, Block, AnnotationType, EditorMode } from './types';
...
const App: React.FC = () => {
  ...
  const [taterMode, setTaterMode] = useState(() => {
    const stored = localStorage.getItem('plannotator-tater-mode');
    return stored === 'true';
  });
  ...
  const handleTaterModeChange = (enabled: boolean) => {
    ...
    localStorage.setItem('plannotator-tater-mode', String(enabled));
  };
